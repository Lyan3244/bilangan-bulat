...
<body>
    ...
    <br>
    <br>
        <h1 class="text-white mt-4 mb-4">RAPOR SISWA MATERI BILANGAN BULAT</h1>
            ...
            <!-- form start-->
                <form method="post" action="input.php">
                    <div class="input-form">
                        <div>
                            <br>
                                <input type="text" class="form-control border-light" style="padding: 30px 25px;" placeholder="NISN" name = "nisn"><br>
                                <input type="text"class="form-control border-light" style="padding: 30px 25px;" placeholder="Nama" name = "nama"><br>
                                <input type="text" class="form-control border-light" style="padding: 30px 25px;" placeholder="Kelas" name = 'kelas'><br>
                                <input type="text" class="form-control border-light" style="padding: 30px 25px;" placeholder="Nilai" name = 'nilai'><br>
                                <button type = "submit" class="btn btn-secondary px-4 px-lg-5" value = "Submit">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
